...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/ApplePayButton/ApplePayButton.framework"
  ...
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/MyFatoorah/MFSDK.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/Ottu/Ottu.framework"
fi
